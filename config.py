...
class Config:
    ...
    # NOVAS CONFIGURAÇÕES PARA O SUPABASE STORAGE
    SUPABASE_URL = os.environ.get('SUPABASE_URL')
    SUPABASE_KEY = os.environ.get('SUPABASE_KEY')
    
    # Mantemos o UPLOAD_FOLDER como fallback ou para arquivos temporários
    UPLOAD_FOLDER = '/app/media'
...
class ProductionConfig(Config):
    DEBUG = False
    # No EasyPanel, o UPLOAD_FOLDER local torna-se secundário ao Supabase
    UPLOAD_FOLDER = '/app/media'
